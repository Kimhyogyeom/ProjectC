...
- 플레이어 무적 시간 (피격 후 1.5초, 동시 다발 피격 방지)
- 웨이브 UI (상단 웨이브 번호 + 시작/클리어 중앙 알림)
- 플레이어 사망 처리 (게임 오버 UI, 씬 재시작)

### 🔧 다음 작업
1. **레벨업 & 스킬 선택** — 경험치 획득 → 레벨업 → 스킬 3개 중 택 1
2. **무적 시간 시각 피드백** — 피격 후 플레이어 깜빡임 효과
3. **UI 디자인** — 웨이브 UI, 게임 오버 UI, HP 바 디자인 다듬기
4. **캐릭터/적 비주얼** — 플레이어·적 모델 및 애니메이션
