...
#### 리텐션
2. **데일리 보상** — 출석 보상 시스템 (로비에서 매일 골드 지급)
3. **오프라인 보상** — 접속 안 한 시간만큼 골드 지급
4. **업적/도전과제** — 목표 달성 시 보상 (보스 처치 N회 등)
...
7. **IAP** — 인앱 결제
8. **보석 상점** — 광고/IAP 연동
9. **LevelPlay Placement 등록** — 부활 광고 배치 추가 (수익 분석용, 필수 아님)

#### 장기
10. **장비 시스템** — 무기 3~5종, 강화/합성
