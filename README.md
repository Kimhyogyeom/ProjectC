...
#### UI / 시스템 (Unity 셋업 필요)
1. **게임 결과 화면 UI 셋업** — GameOverPanel에 TMP_Text 3개 바인딩 (웨이브/킬/골드) ← 코드 완료, UI 바인딩만 남음
2. **부활 버튼 UI 셋업** — GameOverPanel에 부활 Button 추가 후 `_reviveButton` 바인딩 ← 코드 완료, UI 바인딩만 남음
...
10. **IAP** — 인앱 결제
11. **보석 상점** — 광고/IAP 연동
12. **LevelPlay Placement 등록** — 부활 광고 배치 추가 (수익 분석용, 필수 아님)

#### 장기
13. **장비 시스템** — 무기 3~5종, 강화/합성
